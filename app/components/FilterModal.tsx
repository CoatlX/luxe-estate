      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto relative w-full max-w-2xl bg-white rounded-xl shadow-2xl flex flex-col max-h-[90vh]">
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar p-8 space-y-10">
            {/* Location */}
            <section>
              <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Location or Title</label>
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder="City, neighborhood, or property title" 
                  type="text" 
                  value={location}
