      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-nordic-dark leading-tight">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 font-medium">{dict.home.hero.title_highlight}</span>
          ...
          <section className="mb-16">
            <div className="flex items-end justify-between mb-8">
              ...
              <a className="hidden sm:flex items-center gap-1 text-sm font-medium text-mosque hover:opacity-70 transition-opacity" href="#">
                {dict.home.featured.view_all} <span className="material-icons text-sm">arrow_forward</span>
              </a>
            </div>
        ...
        <section>
          <div className="flex items-end justify-between mb-8">
            <div>
              <h2 className="text-2xl font-light text-nordic-dark">
                {hasActiveFilters ? dict.home.new_in_market.search_results_title : dict.home.new_in_market.title}
              </h2>
              <p className="text-nordic-muted mt-1 text-sm">
                {hasActiveFilters ? dict.home.new_in_market.search_results_subtitle.replace('{count}', totalItems.toString()) : dict.home.new_in_market.subtitle}
              </p>
            </div>
            <div className="hidden md:flex bg-white p-1 rounded-lg">
              ...
              <button className="px-4 py-1.5 rounded-md text-sm font-medium text-nordic-muted hover:text-nordic-dark">
                {dict.home.new_in_market.buy}
              </button>
              <button className="px-4 py-1.5 rounded-md text-sm font-medium text-nordic-muted hover:text-nordic-dark">
                {dict.home.new_in_market.rent}
              </button>
            </div>
          </div>
          ...
          {totalPages > 1 && (
            <div className="mt-12 flex justify-center items-center gap-4">
              ...
              <span className="text-sm font-medium text-nordic-muted">
                {dict.home.pagination.page_of.replace('{page}', page.toString()).replace('{totalPages}', totalPages.toString())}
              </span>
